...
const Startup = () => {
    ...
    return (
        <motion.div
            ...
            className="absolute z-50 flex items-center justify-center w-full h-full bg-StartupBackground"
        >
            <motion.div
            ...
            >
                <motion.div
                    ...
                    className="absolute w-12 h-2 rounded bg-AAsecondary "
                ></motion.div>
                <motion.div
                    initial={{ scale: 0, x: 0 }}
                ...
                <motion.span
                    ...
                    className="text-4xl text-AAsecondary font-Text2"
                >
                    A
                </motion.span>
            </motion.div>
