...
function Login() {
    ...
    return (
        <div className="flex bg-black flex-col items-center justify-center w-full h-[calc(100vh)] py-0 mx-auto my-0 justify-items-center">
            <form className="w-4/5 px-6 py-3 border-none lg:w-2/5 md:w-3/5 glass text-[#text-[#F9DC34]}">
                ...
                <div className="justify-center w-full my-3 ">
                    ...
                    <div className="flex justify-between w-full py-2 pl-4 pr-2 my-1 bg-transparent border rounded-lg shadow-md form-control border-bgold-200">
                        <input
